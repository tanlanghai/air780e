...
--根据自己的服务器修改以下参数
-- local mqtt_host = "103.215.44.167"
-- local mqtt_port = 1883
-- local mqtt_isssl = false
-- local client_id = "testlua"
-- local user_name = "admin"
-- local password = "Sd_12345"
...
local mqtt_isssl = false
local client_id = "ae7f70e63af8d4d39d804c583cf393eb"
local pub_topic = "mymqtt2"
local sub_topic = "mymqtt250312"
...
sys.taskInit(function()
    ...
    mqttc:auth(client_id,nil,nil) -- client_id必填,其余选填(巴法云)
